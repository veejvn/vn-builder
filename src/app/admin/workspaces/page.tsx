...
import { Workspace, PaginationData } from "@/features/admin/admin.types";
...
export default function WorkspacesManagementPage() {
  ...
  const handleDeleteWorkspace = async (id: string) => {
    if (
      confirm(
        "Are you sure you want to delete this workspace? This will soft delete it."
      )
    ) {
      try {
      ...
      <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
        <div>
          ...
          <p className="text-[#9da8b9] mt-1 text-base">
            Manage all workspaces active on the platform.
          </p>
        </div>
      </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-border-dark text-sm">
              {loading ? (
                <tr>
                  <td colSpan={5} className="py-10 text-center text-[#9da8b9]">
                    ...
                    <td className="py-3 px-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="text-[#9da8b9] text-xs truncate max-w-[200px]">
                    ...
                    <td className="py-3 px-4">
                      <div className="flex flex-col">
                        <span className="text-white">
                          {(workspace.owner as any)?.name}
                        </span>
                        <span className="text-[#9da8b9] text-xs">
                          {(workspace.owner as any)?.email}
                        </span>
                      </div>
                    </td>
